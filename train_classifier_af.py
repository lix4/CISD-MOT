import torch
from losses.mask_ce_af import masked_cross_entropy_loss
...
from models.MOT_IVD_v1_8 import MOT_IVD_v1_8
from models.MOT_IVD_v2_1 import MOT_IVD_v2_1
from models.MOT_IVD_v2_2 import MOT_IVD_v2_2
from models.MOT_IVD_v3_1 import MOT_IVD_v3_1
from models.AVIVDNet_v5_6_1 import AVIVDNetV5_6_1
...
def validate_one_epoch(model, dataloader, device, num_classes=3):
    ...
    with torch.no_grad():
        for batch in dataloader:
            ...
            logits, _ = model(bboxes, audio)  # [BN, L, C]
...
def train_loop(model, train_loader, val_loader, optimizer, device, num_epochs, checkpoint_dir):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        f1, mAP = validate_one_epoch(model, val_loader, device)
...
if __name__ == "__main__":
    checkpoint_dir = 'MOT_classification_v1_8'
    use_cuda = True
    num_workers = 8
    batch_size = 16
    ...
    model = MOT_IVD_v1_8(num_classes=3).cuda()
    ...
    train_loop(model, train_loader, valid_loader, optimizer, device, num_epochs, checkpoint_dir)
