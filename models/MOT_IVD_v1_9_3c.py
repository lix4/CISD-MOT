...
# ---------- Main Model ----------
class MOT_IVD_v1_9_3c(nn.Module):
    """改进版：
    ...
    def __init__(self, num_classes=3, d=256, heads=4):
        ...
        # -------- 音频 backbone --------
        # 6 通道谱图 → 3 通道，可学习映射
        self.rgb_conv = nn.Conv2d(3, 3, kernel_size=1, bias=False)
...
if __name__ == "__main__":
    ...
    dummy_audio = torch.randn(BN, 3, 128, 469).cuda()

    # 创建模型实例
    model = MOT_IVD_v1_9_3c(num_classes=C).cuda()
